...
# Used by .github/workflows/publish-image.yml before image pack/push.
#
#   deploy/bin/amd64/flashcards  must be x86-64
#   deploy/bin/arm64/flashcards  must be ARM aarch64
set -euo pipefail
